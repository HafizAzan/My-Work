...
function CustomForm({ onSubmit, handleSubmit, control, watch }) {
  ...
  return (
    <>
      ...
      >
        ...
        />
        <CustomButton
          className={`origin-custom-transition pt-5 pb-5 text-white w-[33vw] rounded-[5px] border-sky-500 border-[2px] font-semibold text-[1.2vw] ${
